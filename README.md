...
> **Что:** курсовая по научным вычислениям — осаждение флокулированного красного шлама в сгустителе и противоточная промывка щёлочи в процессе Байера.
> **Стек:** Python, NumPy, SciPy (optimize, integrate, linalg), pandas, matplotlib.
> **Результат:** подгонка кривых осаждения (T₁ ≈ 49.4 с, R² ≈ 0.91), Na₂O 38.0 → 1.45 г/л (≈ 99 % отмывки), 20-классовая популяционно-балансовая модель роста флокул.
